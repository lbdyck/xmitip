...
//SYSIN    DD  *
*| ====================================================================
*| Function : Unloads T2P load modules.
*|
...
*|                    2 = DELETE of T2PARC4 failed
*|                    3 = DELETE of T2PMD5 failed
*|                    4 = DELETE of T2PCOMP failed
*|
*| Descript : This external REXX function, along with T2PINIT manage
...
*|
*| ====================================================================
T2PTERM  CSECT                                Section
T2PTERM  AMODE    31                          Must be 31
T2PTERM  RMODE    ANY                         Could be 24, but why?
* ---------------------------------------------------------------------
...
* Load other modules
* ---------------------------------------------------------------------
         DELETE   EP=T2PARC4                  ARC4 processor
         LTR      R15,R15                     Good RC?
         BNZ      ERR2                        No, error
         DELETE   EP=T2PMD5                   MD5 processor
         LTR      R15,R15                     Good RC?
         BNZ      ERR3                        No, error
         DELETE   EP=T2PCOMP                  COMP processor
         LTR      R15,R15                     Good RC?
         BNZ      ERR4                        No, error
...
* Error routines
* ---------------------------------------------------------------------
ERR4     LA       R15,4                       COMP DELETE failed
         B        ERR
ERR3     LA       R15,3                       MD5 DELETE failed
         B        ERR
ERR2     LA       R15,2                       ARC4 DELETE failed
         B        ERR
